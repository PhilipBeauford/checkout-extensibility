...
extend(
	...
	query(
		...
		{
		variables: {id: "gid://shopify/Product/8127737200947"}, // Needs to be product ID
		},
	)
		.then(({data}) => {
	...
	const addButtonComponent = root.createComponent(
		...
		onPress: async () => {
			...
			const result = await applyCartLinesChange({
				type: "addCartLine",
				merchandiseId: "gid://shopify/ProductVariant/44462991638835", // Needs to be product variant ID
				quantity: 1,
			});
