  ...
  extend(
	...
	(root, { lines, applyCartLinesChange, query, i18n }) => {
	  ...
	  const imageComponent = root.createComponent(Image, {
		...
		borderRadius: 'large',
		aspectRatio: 1,
		source: "https://cdn.shopify.com/s/files/1/1030/4291/files/summer-23-sticker-pack.jpg?v=1686081511",
	  });
	  const titleMarkup = root.createText("");
	  const priceMarkup = root.createText("");
	  const merchandise = { id: "gid://shopify/ProductVariant/43044855677066" };
